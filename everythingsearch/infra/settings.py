...
def _load_settings() -> Settings:
    ...
    settings = Settings(
        ...
        nl_intent_model=_load_str(local_config, "NL_INTENT_MODEL", default="qwen3.7-flash",
        ),
        search_interpret_model=_load_str(local_config, "SEARCH_INTERPRET_MODEL", default="qwen3.7-flash",
        ),
